...
<div class="admin-page">
    <div class="admin-page-header">
        ...
        <div class="admin-page-header__actions">
            <a href="<?= postUrl($post['slug'], $post['category_slug'] ?? null)?>" class="btn btn-outline"
                target="_blank"><i class="fas fa-eye"></i> View Live</a>
            <a href="<?= APP_URL?>/admin/posts.php?type=<?= h($postType)?>" class="btn btn-outline"><i
                ...
                <div class="form-card editor-form-card">
                    <div class="form-group">
                        ...
                        <div class="editor-field-row editor-field-row--title">
                            ...
                            <button type="button" id="btn-ai-titlify" class="btn btn-outline"><i
                                    class="fas fa-magic"></i> AI Title</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Slug</label>
                        <div class="editor-field-row">
                            <input type="text" id="slug" name="slug" value="<?= h($post['slug'])?>" required>
                            <button type="button" class="btn btn-outline" data-slug-from-title><i
                                    class="fas fa-link"></i> From title</button>
                        </div>
                    </div>
                    ...
                    <div class="ai-writer-panel">
                        ...
                        <div class="ai-writer-panel__row">
                            ...
                            <button type="button" id="btn-ai-generate" class="btn btn-primary"><i
                                    class="fas fa-pen-nib"></i> Write</button>
                        </div>
                        ...
                        <div id="ai-preview-area" class="ai-preview-card">
                            <div class="ai-preview-card__header">
                                ...
                                <div class="ai-preview-card__actions">
                                    ...
                                    <button type="button" id="btn-ai-discard"
                                        class="btn btn-outline btn-sm">Discard</button>
                                </div>
                            </div>
                            <div class="ai-preview-card__grid">
                                <div>
                                    <span class="ai-preview-card__label">Current</span>
                                    <div id="ai-old-preview" class="ai-preview-card__body ai-preview-card__body--muted">
                                    </div>
                                </div>
                                <div>
                                    <span class="ai-preview-card__label">AI suggestion</span>
                                    <div id="ai-new-preview"
                                        class="ai-preview-card__body ai-preview-card__body--accent"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
endforeach; ?>
                    ...
                    <div class="form-group">
                        <label style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                            <input type="checkbox" name="allow_comments" value="1" <?= $post['allow_comments']
    ? 'checked' : '' ?> style="width: 16px; height: 16px;">
                            Allow Comments
                        </label>
                    </div>
                    <div class="form-group"><label>Featured Image</label>
                        <?php if ($post['featured_image']): ?><img
                            src="<?= APP_URL . '/' . h($post['featured_image'])?>"
                            style="width:100%; border-radius:8px; margin-bottom:10px;">
                        <?php
endif; ?>
                        <div class="form-file-upload">
                            <input type="file" name="featured_image" id="input_featured_image"
                                class="form-file-upload__input" accept="image/*">
                            <label for="input_featured_image"
                                class="btn btn-outline btn-sm form-file-upload__label">Choose image</label>
                    ...
                    <div class="form-group">
                        <label>Tags</label>
                        <textarea name="tags" class="form-control form-control--tags" rows="2"
                            placeholder="marketing, seo, web design"><?= h($currentTags)?></textarea>
