...
<style>
/* Style Choices with Previews */
.style-choice { display: block; padding: 12px; border: 1px solid #e2e4e7; border-radius: 10px; cursor: pointer; transition: all 0.2s; position: relative; background: #fff; }
.style-choice.active { border-color: #2271b1; background: #f0f6fb; box-shadow: 0 0 0 1px #2271b1; }
.style-choice input { position: absolute; opacity: 0; pointer-events: none; }

.choice-content { display: flex; align-items: center; gap: 15px; }
.choice-preview { width: 50px; height: 30px; background: #f5f5f5; border-radius: 4px; overflow: hidden; position: relative; flex-shrink: 0; border: 1px solid #ddd; }
.choice-text { font-weight: 500; font-size: 13px; color: #1d2327; }

/* Mini Previews logic - Refined & Contained */
.mobile-simple { display: flex; align-items: flex-end; }
.mobile-simple span { height: 6px; flex: 1; opacity: 0.9; }
.mobile-simple span:first-child { background: #2271b1; }
.mobile-simple span:last-child { background: #25d366; }

.mobile-pill { display: flex; align-items: flex-end; justify-content: center; gap: 4px; padding-bottom: 4px; }
.mobile-pill span { width: 8px; height: 8px; border-radius: 50%; opacity: 0.9; }
.mobile-pill span:first-child { background: #2271b1; }
.mobile-pill span:last-child { background: #25d366; }

.mobile-gradient { 
    background: linear-gradient(to right, #2271b1, #25d366); 
    height: 6px; position: absolute !important; bottom: 0 !important; width: 100% !important; 
    border-radius: 0 0 4px 4px !important; margin: 0 !important; transform: none !important;
}

.desktop-simple { display: flex; align-items: flex-end; }
.desktop-simple span { height: 6px; flex: 1; opacity: 0.9; }
.desktop-simple span:first-child { background: #2271b1; }
.desktop-simple span:last-child { background: #25d366; }

.desktop-pill { display: flex; flex-direction: column; align-items: center; gap: 3px; justify-content: center; height: 100% !important; padding: 0 !important; }
.desktop-pill span { width: 6px; height: 6px; border-radius: 50%; opacity: 0.9; }
.desktop-pill span:first-child { background: #2271b1; }
.desktop-pill span:last-child { background: #25d366; }

.desktop-gradient { 
    display: flex; flex-direction: column; align-items: center; justify-content: center; 
    height: 22px !important; width: 12px !important; border-radius: 10px !important; 
    background: linear-gradient(to bottom, #2271b1, #25d366); 
    position: absolute !important; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%) !important;
}
.desktop-gradient span { width: 4px; height: 4px; border-radius: 50%; background: #fff; margin: 1px; flex-shrink: 0; }

/* Switch UI */
.switch { position: relative; display: inline-block; width: 44px; height: 22px; }
.switch input { opacity: 0; width: 0; height: 0; }
.slider { position: absolute; cursor: pointer; top: 0; left: 0; right: 0; bottom: 0; background-color: #ccd0d4; transition: .4s; }
...
input:checked + .slider[style*="width: 50px"]:before { transform: translateX(24px); }
