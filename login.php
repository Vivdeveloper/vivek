                ...
                if ($user && password_verify($password, $user['password'])) {
                    if ($user['is_blocked']) {
                        ...
                        if (!$hasAdminAccess) {
                            ...
                            if (!empty($perms)) $hasAdminAccess = true;
                        }
    ...
    <div class="auth-wrapper-v2">
        ...
        <div class="auth-left-col">
            <div class="auth-form-container">
                <div class="auth-head">
                    <h1>Welcome back!</h1>
                    <p>Simplify your workflow and boost your productivity with
                        <?= APP_NAME?>. Get started for free.
                    </p>
                </div>
        ...
        <div class="auth-right-col">
            <div class="auth-right-content">
                ...
                <h2 style="font-size: 26px; font-weight: 700; margin-bottom: 12px; color: #000;">Make your work easier
                    and organized</h2>
                <p style="color: #666; font-size: 15px;">with <strong>
                        <?= APP_NAME?>
                    </strong></p>
